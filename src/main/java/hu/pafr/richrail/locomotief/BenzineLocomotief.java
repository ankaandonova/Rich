...
public class BenzineLocomotief implements Locomotief, Cloneable {
	...
	public BenzineLocomotief(String naam, String vertrekPunt, String eindBestemming, String type_moter, Double hoogte,
