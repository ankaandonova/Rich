		...
		try {
			...
			}
			{
				...
				}
				{
					 ...
					 * cbAllTrainsLayout.setColumns(1); cbAllTrainsLayout.setHgap(5);
					 * //cbAllTrainsLayout.setVgap(5); cbAllTrains.setLayout(cbAllTrainsLayout);
					 */
			...
			}
			{
				...
				pnlWagons.setBorder(BorderFactory.createEtchedBorder(BevelBorder.LOWERED));
				{
					...
					pnlWagons.add(tfCurrentTrain, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0,
				...
				}
				{
					...
					pnlWagons.add(jButton1, new GridBagConstraints(1, 2, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
							GridBagConstraints.NONE, new Insets(0, 0, 0, 0), 0, 0));
